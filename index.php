                ...
                <div class="masonry">
                    ...
                    <article class="masonry__brick entry format-standard animate-this">
                        ...
                        <div class="entry__thumb">
                            <a href="single-standard.php?id=<?php echo $article['ID_article']; ?>" class="entry__thumb-link">
                        ...
                        <div class="entry__text">
                            <div class="entry__header">
                                ...
                                <h2 class="entry__title"><a href="single-standard.php?id=<?php echo $article['ID_article']; ?>">  <?php echo $article['title'];  ?> </a></h2>
                                <div class="entry__meta">
                                    ...
                                    <span class="entry__meta-date">
                                        <a href="single-standard.php?id=<?php echo $article['ID_article']; ?>">
